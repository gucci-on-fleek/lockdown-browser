...
### This is a fork of the original version, but this is a patch for versions after `2.1.2.04`. It also allows for better GPU power, so in case there are videos to watch, it's powerful enough. Video and Audio will NOT work after 24H2. Microsoft is working on a fix, but in the meantime, either downgrade or no audio/video.
I made a fork of this to improve safety in the Powershell file and patch the sandbox. It was a very easy fix; I tested this as of 1/17/25. It works on the latest version, `2.1.2.10`.

## Why the _Lockdown Browser_ is bad
First, I am uncomfortable installing random software on my computer. I usually only install software that is open source or from a trusted publisher. This software is neither, so I am naturally uncomfortable installing it.
...
4. Wait. It’ll take about a minute, but the _Lockdown Browser_ will eventually open entirely automatically.
